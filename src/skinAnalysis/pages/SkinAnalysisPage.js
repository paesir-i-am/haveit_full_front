	...
	return (
			...
			<div className="skin-analysis-page">
				<div className="title-section">
					<h1>내 피부, 들여다보기</h1>
					<div>사진을 업로드하면, HAVIT이 당신의 피부 상태를 분석해드립니다.</div>
				</div>
					...
					<div className="guideline-box">
						...
						<div className="guideline-content">
							<div className="image-box">
								<img src="/img/skinanalysis_img.png" alt="Skin Analysis Reference" />
							</div>
							<div className="text-list">
								{["1. 얼굴을 정면에서 촬영하세요.", "2. 밝은 조명에서 촬영하세요.", "3. 깨끗한 얼굴로 촬영하세요.", "4. 고해상도 이미지를 사용하세요."].map((text, idx) => (
										<div className="tip-box" key={idx}>{text}</div>
								))}
							</div>
						</div>
					</div>
